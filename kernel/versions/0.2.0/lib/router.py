...
ROUTES = {
    ...
    # build-class natural language routes to the /zbuild ENGINE skill (the full agent loop),
    # NOT the bare lifecycle 'implement' state-stamp. [Zaude 3 P1]
    "build":       {"safety": PROPOSE, "triggers": ["build", "build it", "build the feature",
                                                    "implement", "implement the feature", "write the code",
                                                    "start coding", "code this", "make a feature",
                                                    "add a feature", "fix the bug"]},
    "implement":   {"safety": PROPOSE, "triggers": ["mark implemented", "record implementation"],
